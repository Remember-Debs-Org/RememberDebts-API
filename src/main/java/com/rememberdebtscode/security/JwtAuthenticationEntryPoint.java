...
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    // Este método se ejecuta cuando un usuario no autenticado intenta acceder a un
    // recurso que requiere autenticación
    @Override
    public void commence(HttpServletRequest request, HttpServletResponse response,
            AuthenticationException authException)
            throws IOException, ServletException {

        // TODO: Obtener el mensaje de error si es que existe, de lo contrario
        ...
        // TODO: Crear un objeto de error personalizado con la fecha, mensaje de error y
        ...
        // TODO: Escribir la respuesta de error en formato JSON en el cuerpo de la
        // respuesta
    ...
    // Método auxiliar para convertir el objeto de error en un JSON para incluirlo
    // en la respuesta HTTP
    private String convertObjectToJson(Object object) throws JsonProcessingException {
        if (object == null) {
            return null;
        }
        // TODO: Convertir el objeto en una cadena JSON utilizando ObjectMapper de
        // Jackson
        ObjectMapper mapper = new ObjectMapper();
        mapper.findAndRegisterModules(); // Esto registra módulos adicionales si es necesario (por ejemplo, soporte de
                                         // fechas)
